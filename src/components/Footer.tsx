        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-silver-light hover:text-teal transition-colors">Privacy Policy</a></li>
              <li><a href="#" className="text-silver-light hover:text-teal transition-colors">Terms of Service</a></li>
          ...
          <div className="mt-4 md:mt-0">
            <form onSubmit={handleNewsletterSubmit} className="flex">
              <input 
                ...
                className="px-4 py-2 rounded-l-full bg-white/10 border-y border-l border-white/20 text-white text-sm focus:outline-none focus:ring-1 focus:ring-teal min-w-[250px]"
                value={email}
              ...
              <button 
                type="submit" 
                className="bg-teal hover:bg-teal-light text-white px-4 py-2 rounded-r-full transition-colors flex items-center justify-center min-w-[110px]"
